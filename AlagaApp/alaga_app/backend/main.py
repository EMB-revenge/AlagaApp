...
# Routers
from .routers import appointments, users, calendar, health_records, medications, subscriptions, care_profiles # Add other routers as needed
...
if __name__ == "__main__":
    ...
    uvicorn.run("main:app", host="0.0.0.0", port=8000, reload=True, app_dir="c:\\Tests\\Alaga\\alaga_app\\AlagaApp\\alaga_app\\backend")
